...
                <h1 style=\"margin-top:0;color:#2a6796;display:inline-block;margin-top: 16pt;\" align=\"left\">SOLICITAÇÃO<br/>DE ORÇAMENTO</h1>\
            </td>\
        </tr>\
        <tr>\
            <td align=\"center\" colspan=\"3\" style=\"font-weight: bold\">\
                <h1 style=\"font-size: 32pt;margin-top: 16pt;\">" + supplier.socialReason + ",</h1>\
                <p style=\"margin-top: 8pt;font-size:17pt;\">você acaba de receber uma nova<br/>solicitação de Orçamento:</p>\
            </td>\
        </tr>\
    </thead>\
    <tbody>\
        <tr>\
			...
			                    <tr><td><label style=\"color: #4782ae; font-weight: bold; display: inline-block; margin-top: 16pt;\">Prazo de entrega</label><p style=\"margin-top: 8pt;font-size:17pt;color: #666;\">Dealine</p></td></tr>\
			                    <tr><td><label style=\"color: #4782ae; font-weight: bold; display: inline-block; margin-top: 16pt;\">Endereço de entrega</label><p style=\"margin-top: 8pt;font-size:17pt;color: #666;\">"+ address.address + ", " + address.number + "</p></td></tr>\
			                </table>\
			            </td>\
			        </tr>\
			    </tbody>\
			...
			<ul style=\"display: inline-block; list-style: none; text-align: right; color: #fff;  float: right; font-weight: bold; margin: 16pt 0; padding-right: 16pt; border-right: 3pt solid #fff;\">\
			    <li style=\"margin: 8pt 0;\"><a style=\"color:#50b7a6;color: #fff; text-decoration: none; white-space: nowrap;\" href=\"http://www.avallie.com\">www.avallie.com</a></li>\
			    <li style=\"margin: 8pt 0;\"><a style=\"color:#50b7a6;color: #fff; text-decoration: none; white-space: nowrap;\"  href=\"mail:comercial@avallie.com\">comercial@avallie.com</a></li>\
